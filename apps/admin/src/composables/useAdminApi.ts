...
import type { Stats, Account, Workspace, Backup, ApiResponse, SystemHealth } from '@huly-tools/types';
...
export function useAdminApi() {
  ...
  function setError(message: string, status?: number, code?: string | number, data?: unknown) {
  ...
  async function createAccount(accountData: Partial<Account>): Promise<Account> {
    return makeRequest<Account>('/accounts', {
      method: 'POST',
  ...
  async function updateAccount(id: string, accountData: Partial<Account>): Promise<Account> {
  ...
  async function createWorkspace(workspaceData: Partial<Workspace>): Promise<Workspace> {
    return makeRequest<Workspace>('/workspaces', {
      method: 'POST',
  ...
  async function updateWorkspace(id: string, workspaceData: Partial<Workspace>): Promise<Workspace> {
