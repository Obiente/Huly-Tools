<template>
  ...
  >
    ...
    <component v-else-if="icon" :is="iconComponent" class="w-4 h-4" />
...
<script setup lang="ts">
  ...
  const buttonClasses = computed(() => [
    "inline-flex hover:scale-110 items-center gap-2 font-medium rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-offset-2",
    // Variants
    {
      "bg-interactive-primary text-inverse focus:ring-blue-500":
